...
import { MAP_CONFIG } from '../../features/businesses/data/mapConfig';
import { getMergedLocations, refreshFinalLocations, FINAL_LOCATIONS } from '../locations/locations';
import { WAYPOINTS } from '../locations/roads';
import { getHouseStyle, getHouseIcon } from '../../features/houses/data/houseStyles';

// Сторы
import { usePlayerStore } from '../../stores/usePlayerStore'; 
import { useTravelStore } from '../../stores/useTravelStore'; 
import { useBusStore } from '../../stores/useBusStore';
import { useHouseStore, type House } from '../../stores/useHouseStore';
import { useVehicleStore } from '../../stores/useVehicleStore';
import { useInventoryStore } from '../../stores/useInventoryStore';
import { useDeliveryStore } from '../../stores/useDeliveryStore';
import { useTruckerStore } from '../../stores/useTruckerStore';
import { useLspdStore } from '../../stores/useLspdStore';
import { useNavigationStore } from '../../stores/useNavigationStore';
import { useJobStore, type ActiveShift } from '../../stores/useJobStore';
import { getJobByLocation, JOBS_DATABASE } from '../../features/jobs/data/jobsConfig';
import { RESOURCE_TYPES } from '../../features/businesses/data/businessConfig';
...
import FishingPortView from '../../features/businesses/FishingPortView';
import FarmView from '../../features/businesses/FarmView';
import FactoryView from '../../features/businesses/FactoryView';
import OilRigView from '../../features/businesses/OilRigView';
import WorkshopView from '../../features/jobs/WorkshopView';
import TruckerView from '../../features/jobs/TruckerView';
import CafeteriaView from '../../features/businesses/CafeteriaView';
import BankView from '../../features/market/BankView';
import ExportView from './ExportView'; // Скупщик руды
import StripClubView from '../../features/businesses/StripClubView';
import JobView from '../../features/jobs/JobView';
import DrivingSchoolView from '../../features/businesses/DrivingSchoolView';
import GunRangeView from '../../features/businesses/GunRangeView';
import BoxClubView from '../../features/businesses/BoxClubView';
...
export default function MapView({ }: MapViewProps) {
  ...
  const handleMapLongPress = (e: React.PointerEvent) => {
    if (isMoving) {
    ...
    const mapX = Math.round((e.clientX - transform.positionX) / scale);
    const mapY = Math.round((e.clientY - transform.positionY) / scale);
  ...
  useEffect(() => {
    ...
    const unsubPosition = useTravelStore.subscribe((state) => {
      if (state.animatedPosition) positionRef.current = state.animatedPosition;
    });
    const unsubRotation = useTravelStore.subscribe((state) => {
          ...
          <div className="relative" style={{ width: `${MAP_CONFIG.width}px`, height: `${MAP_CONFIG.height}px` }}>
            ...
            <div
              ...
              onMouseDown={(e) => {
                ...
                longPressTimer.current = setTimeout(() => handleMapLongPress(e as unknown as React.PointerEvent), 500);
              }}
              ...
              onTouchStart={(e) => {
                ...
                longPressTimer.current = setTimeout(() => handleMapLongPress(touch as unknown as React.PointerEvent), 500);
              }}
                      ...
                      <button
                        ...
                        if (isHouse) {
                          ...
                          if (isMyHouse && isNear) {
                            ...
                            setSelectedHouse(hWithD as unknown as House);
                          }
                         }
            ...
            {garbageShift?.kind === 'garbage' && garbageShift.activeBins && (
              <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 22 }}>
                {garbageShift.activeBins.map((binId, index) => {
                  ...
                  const isPassed = binId !== garbageShift.selectedBinId && ((garbageShift.status as string) === 'driving_to_base' || (garbageShift.status as string) === 'driving_to_base');
