...
import { getLinkedLocations, saveEditorLocations, resetEditorLocations, getSavedEditorLocations, refreshFinalLocations, resetLocationToDefault, DEFAULT_LOCATIONS } from '../locations/locations';
...
export default function RoadEditor({ onClose }: RoadEditorProps) {
            ...
            {existingLocations.map((loc, idx) => {
              ...
              return (
                <div key={`existing-${loc.id}`} className="absolute opacity-60" style={{ left: `${loc.x}px`, top: `${loc.y}px`, transform: 'translate(-50%, -50%)' }}>
                  <div
                    onMouseDown={(e) => handleLocationMouseDown(e, loc, 'existing', idx)}
