...
import { getControlLevel, TERRITORY_STATUSES } from '../gangs/data/territoriesConfig';

interface TerritoriesViewProps { onClose: () => void; }

export default function TerritoriesView({ onClose }: TerritoriesViewProps) {
