...
import { useOrganizationStore, ORG_VEHICLE_TYPES } from '../../stores/useOrganizationStore';
import { usePlayerStore } from '../../stores/usePlayerStore';
import { ORGANIZATIONS } from '../gangs/data/organizationsConfig';

// ————————————————— ———— Список организаций ————————————————— ————
interface OrganizationsListProps { onClose: () => void; }
export function OrganizationsList({ onClose }: OrganizationsListProps) {
...
// ————————————————— ———— Панель организации ————————————————— ————
interface OrganizationPanelProps { orgId: string; onClose: () => void; }
export function OrganizationPanel({ orgId, onClose }: OrganizationPanelProps) {
  const {
