...
import { useVehicleStore, calculateEffectiveSpeed, calculateEffectiveAcceleration, calculateEffectiveHandling } from '../../stores/useVehicleStore';
import { VEHICLE_DATABASE, WEAR_SYSTEMS, WEAR_SYSTEM_ORDER, DIAGNOSTIC_COST } from '../vehicles/data/vehicleConfig';
