...
export default function GarageView() {
  ...
  const [paintingVehicle, setPaintingVehicle] = useState<Vehicle | null>(null);

  const handleDriveAway = async (vehicleId: string) => {
  ...
  const handlePaint = async (veh: Vehicle, color: string) => {
