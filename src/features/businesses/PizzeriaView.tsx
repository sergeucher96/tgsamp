...
import { useDeliveryStore, type DeliveryJob } from '../../stores/useDeliveryStore';
import { usePlayerStore, type Profile } from '../../stores/usePlayerStore';
import { useTravelStore } from '../../stores/useTravelStore';

interface PizzeriaViewProps {
  onClose: () => void;
}

export default function PizzeriaView({ onClose }: PizzeriaViewProps) {
  ...
  const job = activeDeliveryJob as DeliveryJob | null;
