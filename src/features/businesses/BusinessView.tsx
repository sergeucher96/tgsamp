...
export default function BusinessView({ businessId, onClose }: BusinessViewProps) {
  ...
  const bizType = BUSINESS_TYPES[locType] as BusinessTypeConfig | undefined;
  ...
  const locInfo = FINAL_LOCATIONS?.find((l: Location) => l.id === businessId);
                ...
                <div className="space-y-3">
                  ...
                  <div className="rounded-3xl border border-[#7eff67]/10 bg-[#09170d]/80 p-4">
                    ...
                    {salesHistory.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {salesHistory.map((sale: BusinessSale) => (
                          <div key={sale.id} className="rounded-2xl bg-[#0b1b0d]/90 p-3 border border-[#7eff67]/10">
                            ...
                            <div className="flex items-center justify-between mt-1">
                              {(() => {
                                ...
                                if (!rc) return null;
                                const parsed: Record<string, number> = typeof rc === 'string' ? JSON.parse(rc) : rc;
