...
import { useBusinessStore, type BusinessState } from '../../stores/useBusinessStore';
import { useFarmStore } from '../../stores/useFarmStore';
import { useCafeteriaStore, type CafeteriaStoreState } from '../../stores/useCafeteriaStore';
...
const CAFETERIA_DISHES: CafeteriaDish[] = [
...
export default function CafeteriaView({ businessId, onClose }: CafeteriaViewProps) {
  ...
  const handleOrderDish = async (dish: CafeteriaDish) => {
    if (!player) return;
    if (loading) return;
