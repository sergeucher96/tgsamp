...
export default function ATMView({ onClose }: ATMViewProps) {
      ...
      <div className="w-full bg-[#08101a] flex-1 overflow-y-auto p-4">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="bg-white/[0.03] border border-white/6 p-4 rounded-2xl">
            ...
            <div className="text-[9px] text-amber-400/70 mb-2">⚠ Комиссия 3%: {fee > 0 ? `снимете ${withdrawAmount} ₽ → получите ${Number(Number(withdrawAmount) - fee).toFixed(0)} ₽` : '—'}</div>
            <input
              inputMode="decimal"
              placeholder="Сумма"
