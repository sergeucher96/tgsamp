...
import { EQUIPMENT_SLOTS, CLOTHING_DATABASE } from '../character/data/clothingConfig';
import { CHARACTER_STATS, CHARACTER_STATS_MAP, BUFF_STAT_KEYS } from '../character/data/characterStats';
