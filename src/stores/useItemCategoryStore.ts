...
export interface CategoryEffectAllowedLink {
  id: string | number;
  category_id: string | number;
...
export interface CategoryEffectDeniedLink {
  id: string | number;
  category_id: string | number;
  effect_id: string | number;
  effect?: ItemEffect;
...
export interface CategoryActionLink {
  id: string | number;
  category_id: string | number;
...
export interface InheritedProperty extends ItemProperty {
  isRequired: boolean;
  defaultValue: string | number | boolean | null;
  inheritedFrom: string;
}

export interface InheritedEffect extends ItemEffect {
  defaultValue?: string | number | boolean | null;
  inheritedFrom: string;
}

export interface InheritedAction extends ItemAction {
  inheritedFrom: string;
}

export interface InheritedTag extends ItemTag {
  inheritedFrom: string;
}

export interface InheritedTags {
  automatic: InheritedTag[];
  recommended: InheritedTag[];
}

export interface InheritedEffects {
  allowed: InheritedEffect[];
  denied: InheritedEffect[];
}
...
interface ItemCategoryState {
  ...
  tags: ItemTag[];
  items: Item[];
  categoryProperties: CategoryPropertyLink[];
  categoryEffectsAllowed: CategoryEffectAllowedLink[];
  categoryEffectsDenied: CategoryEffectDeniedLink[];
  categoryActions: CategoryActionLink[];
  ...
  addCategoryProperty: (categoryId: string | number, propertyId: string | number, isRequired?: boolean, defaultValue?: string | number | boolean | null) => Promise<CategoryPropertyLink | null>;
  removeCategoryProperty: (categoryId: string | number, propertyId: string | number) => Promise<boolean>;
  addCategoryEffectAllowed: (categoryId: string | number, effectId: string | number, defaultValue?: string | number | boolean | null) => Promise<CategoryEffectAllowedLink | null>;
  removeCategoryEffectAllowed: (categoryId: string | number, effectId: string | number) => Promise<boolean>;
  addCategoryEffectDenied: (categoryId: string | number, effectId: string | number) => Promise<CategoryEffectDeniedLink | null>;
  removeCategoryEffectDenied: (categoryId: string | number, effectId: string | number) => Promise<boolean>;
  addCategoryAction: (categoryId: string | number, actionId: string | number) => Promise<CategoryActionLink | null>;
  removeCategoryAction: (categoryId: string | number, actionId: string | number) => Promise<boolean>;
  addCategoryTag: (categoryId: string | number, tagId: string | number, isAutomatic?: boolean) => Promise<CategoryTagLink | null>;
  removeCategoryTag: (categoryId: string | number, tagId: string | number) => Promise<boolean>;
  createItem: (data: Partial<Item>) => Promise<Item | null>;
  updateItem: (id: string | number, data: Partial<Item>) => Promise<Item | null>;
  deleteItem: (id: string | number) => Promise<boolean>;
  getInheritedProperties: (categoryId: string | number) => InheritedProperty[];
  getInheritedEffects: (categoryId: string | number) => InheritedEffects;
  getInheritedActions: (categoryId: string | number) => InheritedAction[];
  getInheritedTags: (categoryId: string | number) => InheritedTags;
  getChildCategories: (categoryId: string | number) => Category[];
}

export const useItemCategoryStore = create<ItemCategoryState>((set, get) => ({
  // State
  categories: [],
  properties: [],
  effects: [],
