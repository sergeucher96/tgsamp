...
import { VEHICLE_DATABASE, TUNING_CONFIG, HEALTH_PENALTIES, REPAIR_COST_PER_PERCENT, DIAGNOSTIC_COST } from '../features/vehicles/data/vehicleConfig';
import { getDiagnosis, getServiceUpdates, calculateOverallCondition, getPerformanceMultiplier } from '../features/vehicles/utils/vehicleWear';
...
export const useVehicleStore = create((set, get) => ({
  ...
  serviceWearSystem: async (vehicleId, systemKey) => {
    ...
    const WEAR_SYSTEMS = (await import('../features/vehicles/data/vehicleConfig')).WEAR_SYSTEMS;
