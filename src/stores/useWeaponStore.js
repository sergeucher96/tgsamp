...
export const useWeaponStore = create((set, get) => ({
  ...
  buyWeapon: async (weaponType) => {
    ...
    const weaponConfig = await import('../features/market/data/weaponConfig').then(m => m.WEAPON_CONFIG[weaponType]);
  ...
  buyWeaponLicense: async () => {
    ...
    const { GUN_RANGE_SETTINGS } = await import('../features/market/data/weaponConfig');
