...
interface SceneViewerProps { url?: string; locationId?: string; onClose?: () => void; onOpenEditor?: () => void; }

export default function SceneViewer({ url = '/models/myscene.glb', locationId = 'showroom_ls', onClose, onOpenEditor }: SceneViewerProps) {
