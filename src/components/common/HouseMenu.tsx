...
import { getHousePreview } from '../../features/houses/data/houseStyles';
import { useNavigationStore } from '../../stores/useNavigationStore';
import { usePlayerStore } from '../../stores/usePlayerStore';
import type { Profile } from '../../stores/usePlayerStore';
import type { House } from '../../stores/useHouseStore';
...
interface HouseMenuProps {
  ...
  onGPS: (house: House) => void;
  onClose: () => void;
}

export default function HouseMenu({ house, player, onBuy, onGPS, onClose }: HouseMenuProps) {
